...
#apply layout
  case $LAYOUT in
	...
	cd /tmp && wget https://github.com/godlyranchdressing/United-GNOME/raw/master/United-Latest.tar.xz && tar -xvzf United-Latest.tar.xz -C /tmp/ && mv /tmp/United-Latest-Ubuntu/* ~/.local/share/themes/
	fi
